<div class="p-8 lg:p-12 bg-base-100 border-b border-base-200 rounded-b-xl shadow-lg">

    <div class="flex flex-col items-center justify-center text-center">
        <h1 class="text-4xl md:text-5xl font-extrabold text-primary leading-tight">
            {{ 'Welcome to ' . config('app.name') }}
        </h1>
        <h2 class="mt-4 text-xl md:text-2xl  font-medium">
            Visual task management made simple
        </h2>
    </div>

    <p class="mt-8  leading-relaxed text-lg max-w-3xl mx-auto">
...
<div
    ...
    <div
        class="bg-base-100 p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 border border-base-200">
        <div class="flex items-center mb-3">
            ...
            <h2 class="ms-3 text-xl font-semibold ">
                <a href="{{ route('boards.show') }}" class="hover:text-primary transition-colors duration-200">View All
                    Boards</a>
            </h2>
        </div>

        <p class="mt-4   leading-relaxed">
            Access and manage all your Kanban boards, organized by their respective teams, for a comprehensive overview
            of your projects.
        </p>

        <p class="mt-6 text-sm">
            <a href="{{ route('boards.show') }}"
                class="inline-flex items-center font-semibold text-primary hover:scale-105 transition-colors duration-200">
                Go to Boards
